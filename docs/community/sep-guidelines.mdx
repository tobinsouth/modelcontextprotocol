...
SEPs should be submitted as a GitHub Issue in the [specification repository](https://github.com/modelcontextprotocol/specification). The draft must be written in the style of this SEP and must include:
...
- A complete implementation demonstrating the proposal
