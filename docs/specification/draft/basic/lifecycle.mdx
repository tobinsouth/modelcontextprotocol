...
Implementations **MAY** choose to support a developedment sandbox, which allows regsitered external developers access and use the MCP server without effecting production enviorments. 
This can be used for server testing, evaluations, and AI model training using your MCP server.
